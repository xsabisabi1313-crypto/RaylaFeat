...
public:	
	...
	TArray<TSubclassOf<ACard>> AkazkinTeamCardSet;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Setting")
	TArray<TSubclassOf<ACard>>MomotaroTeamCardSet;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Setting")
	TArray<TSubclassOf<AUnit>>MomotaroTeamUnitSet;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Setting")
	TArray<TSubclassOf<AUnit>>AkazukinTeamUnitSet;
